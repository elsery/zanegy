<script type="text/javascript">
    ...
    <?php if(Auth::check()): ?>
        ...
        BotbleVariables.authorized = "<?php echo e(setting('membership_authorization_at') &&Carbon\Carbon::now()->diffInDays(Carbon\Carbon::createFromFormat('Y-m-d H:i:s', setting('membership_authorization_at'))) <= 7 ? 1 : 0); ?>";
    <?php else: ?>
        BotbleVariables.languages = {
            notices_msg: <?php echo json_encode(trans('core/base::notices'), JSON_HEX_APOS); ?>,
        };
...
<?php $__env->startPush('footer'); ?>
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\work.com\platform/core/base/resources/views/elements/common.blade.php ENDPATH**/ ?>