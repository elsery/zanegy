    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="float-start btn btn-danger" href="#" id="hide-widget-confirm-bttn"><?php echo e(trans('core/dashboard::dashboard.confirm_hide_btn')); ?></a>
                <button type="button" class="float-end btn btn-primary" data-bs-dismiss="modal"><?php echo e(trans('core/dashboard::dashboard.cancel_hide_btn')); ?></button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="modal-body with-padding">
                    <?php $__currentLoopData = $widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $widget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="wrap_<?php echo e($widget->name); ?>">
                            ...
                            <div class="swc_wrap">
                                <?php echo Form::onOff('widgets[' . $widget->name . ']', $widget_setting ? $widget_setting->status : true); ?>
...
<?php /**PATH C:\xampp\htdocs\work.com\platform/core/dashboard/resources/views/partials/modals.blade.php ENDPATH**/ ?>