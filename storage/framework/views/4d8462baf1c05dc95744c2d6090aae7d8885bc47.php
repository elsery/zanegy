...
<div id="edit-slug-box" <?php if(empty($value) && !$errors->has($name)): ?> class="hidden" <?php endif; ?> data-field-name="<?php echo e(SlugHelper::getColumnNameToGenerateSlug($model)); ?>">
    <?php if(in_array(Route::currentRouteName(), ['pages.create', 'pages.edit']) && BaseHelper::isHomepage(Route::current()->parameter('page.id'))): ?>
...
<?php /**PATH C:\xampp\htdocs\work.com\platform/packages/slug/resources/views/permalink.blade.php ENDPATH**/ ?>