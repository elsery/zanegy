        ...
        <div class="next-form-grid-cell">
            <div class="table-wrap p-none">
                <table class="table border-bottom mb0">
                    <thead>
                    <tr>
                        <th class="text-start"><?php echo e(trans('plugins/ecommerce::products.form.product')); ?></th>
                        ...
                        <tr>
                            <td class="text-start width-300-px">
                                <a class="text-underline wordwrap"
                                    ...
                                    target="_blank" title="<?php echo e($orderProduct->product_name); ?>"><?php echo e($orderProduct->product_name); ?></a>
                            </td>
            ...
            <div class="table-wrap p-none">
                <table class="refund-totals">
                    ...
                    <?php endif; ?>
                    <tr>
                        <td class="text-end"><?php echo e(trans('plugins/ecommerce::products.form.shipping_fee')); ?></td>
                    ...
                    <?php if(is_plugin_active('payment') && $order->payment->refunded_amount): ?>
                        <tr>
                            <td class="text-end"><?php echo e(trans('plugins/ecommerce::order.total_refund_amount')); ?>:</td>
                    ...
                    <?php endif; ?>
                    <tr>
                        <td class="text-end"><?php echo e(trans('plugins/ecommerce::order.total_amount_can_be_refunded')); ?>:</td>
                        <td class="text-end quantity text-no-bold">
            ...
            <?php if(is_plugin_active('payment') && $order->payment->status !== \Botble\Payment\Enums\PaymentStatusEnum::PENDING && ($order->payment->amount - $order->payment->refunded_amount) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="p-xs width-150-px">
                                <div class="next-input--stylized">
                                    <input type="text" class="next-input next-input--invisible input-mask-number input-sync-item" data-thousands-separator="<?php echo e(EcommerceHelper::getThousandSeparatorForInputMask()); ?>" data-decimal-separator="<?php echo e(EcommerceHelper::getDecimalSeparatorForInputMask()); ?>" data-target=".refund-amount-text" name="refund_amount" value="<?php echo e($order->payment->amount - $order->payment->refunded_amount); ?>">
...
<?php /**PATH C:\xampp\htdocs\work.com\platform/plugins/ecommerce/resources/views/orders/refund/modal.blade.php ENDPATH**/ ?>