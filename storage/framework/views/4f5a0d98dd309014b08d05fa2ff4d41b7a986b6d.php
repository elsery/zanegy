<?php if(setting('payment_stripe_status') == 1): ?>
    <li class="list-group-item">
        <input class="magic-radio js_payment_method" type="radio" name="payment_method" id="payment_stripe"
               value="stripe" <?php if($selecting == STRIPE_PAYMENT_METHOD_NAME): ?> checked <?php endif; ?>>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\work.com\platform/plugins/stripe/resources/views/methods.blade.php ENDPATH**/ ?>