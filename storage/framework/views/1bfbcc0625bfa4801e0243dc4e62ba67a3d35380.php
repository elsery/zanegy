<?php if(! $alreadyConsentedWithCookies): ?>

    <div class="js-cookie-consent cookie-consent cookie-consent-<?php echo e(theme_option('cookie_consent_style', 'full-width')); ?>" style="background-color: <?php echo e(theme_option('cookie_consent_background_color', '#000')); ?> !important; color: <?php echo e(theme_option('cookie_consent_text_color', '#fff')); ?> !important;">
        <div class="cookie-consent-body" style="max-width: <?php echo e(theme_option('cookie_consent_max_width', 1170)); ?>px;">
            <span class="cookie-consent__message">
                ...
                <?php if(theme_option('cookie_consent_learn_more_url') && theme_option('cookie_consent_learn_more_text')): ?>
                    <a href="<?php echo e(route('public.single', theme_option('cookie_consent_learn_more_url'))); ?>"><?php echo e(theme_option('cookie_consent_learn_more_text')); ?></a>
                <?php endif; ?>
            </span>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\work.com\platform/plugins/cookie-consent/resources/views/index.blade.php ENDPATH**/ ?>