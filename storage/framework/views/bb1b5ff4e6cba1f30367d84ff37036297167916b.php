<div class="rv-media-container">
    <div class="rv-media-wrapper">
        ...
        <aside class="rv-media-aside <?php if(RvMedia::getConfig('sidebar_display') != 'vertical'): ?> rv-media-aside-hide-desktop <?php endif; ?>">
                    ...
                    <div class="rv-media-actions">
                        ...
                        <?php if(RvMedia::hasPermission('files.create')): ?>
                            ...
                            <button class="btn btn-success js-download-action" type="button">
                                <i class="fas fa-cloud-download-alt"></i> <?php echo e(trans('core/media::media.download_link')); ?>
    ...
    <div class="rv-modals">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                ...
                <div class="modal-content">
                    <form class="rv-form form-rename">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(trans('core/media::media.close')); ?></button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="rv-form form-alt-text">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fas fa-file-signature"></i> <?php echo e(trans('core/media::media.alt_text')); ?>
                ...
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"><?php echo e(trans('core/media::media.close')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal_download_url">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" data-downloading="<?php echo e(trans('core/media::media.downloading')); ?>" data-text="<?php echo e(trans('core/media::media.download_link')); ?>">
                            <i class="fas fa-cloud-download-alt"></i> <?php echo e(trans('core/media::media.download_link')); ?>
                    ...
                    <div class="modal-body">
                        <form class="rv-form form-download-url">
                            <div id="download-form-wrapper">
                                ...
                                <?php echo Form::helper(trans('core/media::media.download_explain')); ?>

                            </div>
                            <button class="btn btn-success w-100" type="submit"><?php echo e(trans('core/media::media.download_link')); ?></button>
                        </form>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form class="rv-form form-crop">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fas fa-crop"></i> <?php echo e(trans('core/media::media.crop')); ?>
                                ...
                                <div class="col-lg-3">
                                    <div class="mt-3">
                                        <div class="form-group">
                                            <label class="form-label"><?php echo e(trans('core/media::media.cropper.height')); ?></label>
                                            <input type="text" class="form-control" id="dataHeight">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label"><?php echo e(trans('core/media::media.cropper.width')); ?></label>
                                            <input type="text" class="form-control" id="dataWidth">
                                        </div>
                                        <div class="form-group">
                                            <input type="checkbox" class="custom-control-input" id="aspectRatio">
                                            <label for="aspectRatio"><?php echo e(trans('core/media::media.cropper.aspect_ratio')); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(trans('core/media::media.close')); ?></button>
                            <button type="submit" class="btn btn-primary"><?php echo e(trans('core/media::media.crop')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="media-download-popup">
    <div class="alert alert-success">
        ...
        <?php echo e(trans('core/media::media.prepare_file_to_download')); ?>

    </div>
</div>
<?php /**PATH C:\xampp\htdocs\work.com\platform/core/media/resources/views/content.blade.php ENDPATH**/ ?>