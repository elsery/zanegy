<div class="single-social-share clearfix mt-50 mb-15">
    <p class="mb-15 mt-30 font-sm">
        ...
        <span class="d-inline-block"><?php echo e(__('Share this')); ?></span>
    </p>
    <div class="mobile-social-icon wow fadeIn mb-sm-5 mb-md-0 animated">
        <a class="facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode($url)); ?>" target="_blank">
        ...
        <a class="twitter" href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode($url)); ?>&text=<?php echo e(strip_tags($description)); ?>" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path fill="none" d="M0 0h24v24H0z"/>
        ...
        <a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(urlencode($url)); ?>&summary=<?php echo e(rawurldecode(strip_tags($description))); ?>" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path fill="none" d="M0 0h24v24H0z"/>
...
<?php /**PATH C:\xampp\htdocs\work.com\platform/themes/nest/partials/social-share.blade.php ENDPATH**/ ?>