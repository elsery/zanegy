...
return [
    ...
    'visits' => 'visits',
    'views' => 'views',
    'property_id_not_specified' => 'You must provide a valid view id. The document here: <a href="https://docs.zanegy.com/cms/master/plugin-analytics" target="_blank">https://docs.zanegy.com/cms/master/plugin-analytics</a>',
    'credential_is_not_valid' => 'Analytics credentials is not valid. The document here: <a href="https://docs.zanegy.com/cms/master/plugin-analytics" target="_blank">https://docs.zanegy.com/cms/master/plugin-analytics</a>',
    'start_date_can_not_before_end_date' => 'Start date :start_date cannot be after end date :end_date',
    'wrong_configuration' => 'To view analytics you\'ll need to get a Google Analytics client id and add it to your settings. <br /> You also need JSON credential data. <br /> The document here: <a href="https://docs.zanegy.com/cms/master/plugin-analytics" target="_blank">https://docs.zanegy.com/cms/master/plugin-analytics</a>',
