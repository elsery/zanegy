...
<div class="archive-header-3 mt-30 mb-80"
    style="background-image: url({{ $coverImage ? RvMedia::getImageUrl($coverImage) : Theme::asset()->url('imgs/vendor/vendor-header-bg.jpg') }})">
    <div class="archive-header-3-inner">
        <div class="vendor-logo mr-50">
            <img src="{{ RvMedia::getImageUrl($store->logo, 'medium', false, RvMedia::getDefaultImage()) }}" alt="{!! BaseHelper::clean($store->name) !!}" />
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="vendor-des mb-15">
                        <p class="font-sm text-white">{!! BaseHelper::clean($store->description !!}</p>
                    </div>
                </div>
                <div class="col-lg-3">
