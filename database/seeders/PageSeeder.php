...
class PageSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $bigBanner = Html::tag(
            'div',
            '[big-banner cover_image="general/home-6.jpg" show_newsletter_form="yes" number_display_featured_categories="4" title="What are you looking for?"][/big-banner]'
        );
        ...
        $bigBanner = Html::tag(
            'div',
            '[big-banner cover_image="general/home-6.jpg" show_newsletter_form="yes" number_display_featured_categories="4" title="Bạn đang tìm kiếm sản phẩm?"][/big-banner]'
        );
